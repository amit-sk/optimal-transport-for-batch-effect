...
def main():
    # sanity_check.SanityCheck(should_run_pcoa=True, should_show_pcoa=False).run_test()
    # sanity_check_with_entropy.SanityCheckWithEntropy(epsilon=10**-3.5, should_run_pcoa=True, should_show_pcoa=False).run_test()
    # unsupervised_transport_test.UnsupervisedTransportTest(should_run_pcoa=True, should_show_pcoa=False).run_test()
    ...
    # split_database_sanity_check.SplitDatabaseSanityCheck(should_run_pcoa=True, should_show_pcoa=False).run_test()
