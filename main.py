...
def main():
    ...
    # sanity_check_with_entropy.SanityCheckWithEntropy(epsilon=10**-3.5, should_run_pcoa=True).run_test()
    ...
    split_database_with_entropy_sanity_check.SplitDatabaseWithEntropySanityCheck(epsilon=10**-3.5, should_run_pcoa=True).run_test()
    print("Done.")
